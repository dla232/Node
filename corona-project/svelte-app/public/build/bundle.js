...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 123, 0, 4192);
    			attr_dev(canvas0, "id", "corona_chart");
    			add_location(canvas0, file$1, 125, 4, 4238);
    			attr_dev(canvas1, "id", "corona_chart2");
    			add_location(canvas1, file$1, 126, 4, 4279);
    			attr_dev(div, "class", "char_wrap svelte-s2i7lc");
    			add_location(div, file$1, 124, 0, 4209);
    			add_location(button0, file$1, 128, 0, 4325);
    			add_location(button1, file$1, 131, 0, 4392);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [cr_chart, click_handler, click_handler_1];
    }
